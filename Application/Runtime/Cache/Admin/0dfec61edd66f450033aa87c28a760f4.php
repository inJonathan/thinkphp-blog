            ...
            <form action="" method="post">
                <ul class="admin_items">
                    ...
                    <li>
                        ...
                        <input type="text" name="verify" id="verify" size="10" class="admin_input_style" /><img style="cursor:pointer;" width="100" height="40" onclick="this.src='/blog/index.php/Admin/Login/verify/'+Math.random();" src="/blog/index.php/Admin/Login/verify">
                    </li>
                    <li>
