...
<html>
    ...
    <head>
        ...
        <title>美文网_美文欣赏_经典美文_励志文章_优美散文_倬空间</title>
        ...
        <meta name="description" content="意空间青春励志文章阅读网为读者奉献青春励志人生哲理文章故事阅读，励志的文章大全，青春励志语录名言，青春励志短文阅读，励志的故事欣赏阅读，提升思想意境，阅读改变思想。" />-->
    ...
    <div class="inner">
        <ul class="nav">
            ...
            <?php if(is_array($cateres)): $i = 0; $__LIST__ = $cateres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li <?php if($vo["id"] == $current): ?>class="current-menu-item"<?php endif; ?> >
            ...
            <div class="content">
                ...
                <ul class="excerpt thumb">
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                            <a href="/blog/index.php/Home/Article/index/id/<?php echo ($vo["id"]); ?>" class="pic"><img src="/blog/<?php echo ($vo["pic"]); ?>" alt="<?php echo ($vo["title"]); ?>" /></a>
